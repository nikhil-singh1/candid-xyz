...
export default function AboutUs() {
  ...
  const leaders = [
    ...
    },
    {
      ...
      img: "Zoeb.jpeg",
      description:
        "Zoeb  is a Health IT specialist with over 16 years of experience managing EHR systems like Epic and Cerner. He has led digital transformation initiatives across medium and large healthcare organizations, with a focus on improving clinical care, patient management, and process automation. As a Program Manager, Zoeb has overseen EHR upgrades and efficiency efforts across the U.S. He has successfully delivered eCQM reporting projects supporting JCI accreditation and implemented EHR solutions in inpatient settings to enhance clinical outcomes. A certified PMP, Zoeb brings expertise in project management, stakeholder engagement, and operational optimization. He has managed large-scale Epic implementations and led application maintenance projects using Onshore-Offshore models, driving SLA compliance, automation, and improved staff utilization.",
    },
    {
