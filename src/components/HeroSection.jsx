      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between z-10 relative">
        ...
        <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0 text-white">
          ...
          <p className="text-lg md:text-xl mb-8 opacity-90 rounded-md">
            Amid uncertainty and change, the healthcare sector is looking for new ways to transform the journey of care. By focusing on the differentiated needs of healthcare stakeholders, our global network can help your business transform uncertainty into possibility, and rapid change into lasting progress.
          </p>
